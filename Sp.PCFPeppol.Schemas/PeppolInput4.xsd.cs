namespace Sp.PCFPeppol.Schemas {
    ...
    [Schema(@"urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2",@"CreditNote")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"CreditNote"})]
    ...
    public sealed class PeppolInput4 : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:tns=""urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2"" attributeFormDefault=""unqualified"" elementFormDefault=""unqualified"" targetNamespace=""urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""CreditNote"">
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element xmlns:q7=""urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2"" ref=""q7:CreditNoteTypeCode"" />
        ...
        <xs:element xmlns:q33=""urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"" ref=""q33:CreditNoteLine"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
</xs:schema>";
