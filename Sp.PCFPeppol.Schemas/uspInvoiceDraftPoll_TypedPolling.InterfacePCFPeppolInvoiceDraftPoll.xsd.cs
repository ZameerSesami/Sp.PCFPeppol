namespace Sp.PCFPeppol.Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "InstanceIdentifier", XPath = @"/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll']/*[local-name()='InstanceIdentifier' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll']", XsdType = @"string")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"TypedPollingResultSet0", @"ArrayOfTypedPollingResultSet0", @"TypedPolling"})]
    public sealed class uspInvoiceDraftPoll_TypedPolling_InterfacePCFPeppolInvoiceDraftPoll : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:tns=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  ...
  <xs:element name=""TypedPollingResultSet0"" nillable=""true"" type=""tns:TypedPollingResultSet0"">
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          <b:property distinguished=""true"" xpath=""/*[local-name()='TypedPollingResultSet0' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll']/*[local-name()='InstanceIdentifier' and namespace-uri()='http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolInvoiceDraftPoll']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
  </xs:element>
  ...
  <xs:element name=""TypedPolling"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        public uspInvoiceDraftPoll_TypedPolling_InterfacePCFPeppolInvoiceDraftPoll() {
        }
