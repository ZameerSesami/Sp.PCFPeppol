namespace Sp.PCFPeppol.Schemas {
    ...
    public sealed class uspPCFPeppolPoll_TypedPolling_InterfacePCFPeppolPolling : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:tns=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolPolling"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolPolling"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <fileNameHint xmlns=""http://schemas.microsoft.com/servicemodel/adapters/metadata/xsd"">TypedPolling.InterfacePCFPeppolPolling</fileNameHint>
    </xs:appinfo>
  </xs:annotation>
  ...
  <xs:element name=""TypedPolling"">
    <xs:annotation>
      <xs:documentation>
        ...
        <doc:description xmlns:doc=""http://schemas.microsoft.com/servicemodel/adapters/metadata/documentation"">EXEC [V6DATA_PCF].[dbo].[InterfacePCFPeppolPolling]</doc:description>
      </xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        ...
        public uspPCFPeppolPoll_TypedPolling_InterfacePCFPeppolPolling() {
        }
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolPolling",@"ArrayOfTypedPollingResultSet0")]
        [System.SerializableAttribute()]
        ...
        [Schema(@"http://schemas.microsoft.com/Sql/2008/05/TypedPolling/InterfacePCFPeppolPolling",@"TypedPolling")]
        [System.SerializableAttribute()]
